...
from comparison_helper import ComparisonBetweenStations, aggregate, map_colors
...
df = pd.read_csv('berlin_bikedata_2017-2019_reduced.csv', index_col='timestamp', parse_dates=True)
                    ...
                    [
                        html.Div(
                            [
                                ...
                                dcc.Markdown('''This bike traffic dashboard shows data from bicycle counters in Berlin.
                                                Each bicycle counter counts the amount of bicycles passing per hour.  
                                                [Data](https://www.berlin.de/sen/uvk/verkehr/verkehrsplanung/radverkehr/weitere-radinfrastruktur/zaehlstellen-und-fahrradbarometer/) is accessible starting from 2012.
                                                This dashboard includes the latest data from 2017 through 2019.  
                                                More information and code on [Github](https://github.com/senzelden/berlin_bike_traffic).'''),
...
def update_fig(year, station, timeframe, radialrange):
    ...
    agg_comp_df = aggregate(df, comparison)
